...
export PATH=".local:$HOME/etc/bin:$HOME/toolbox/bin:/usr/local/bin:/usr/local/sbin:/opt/local/sbin:/opt/local/bin:/sbin:/bin:/usr/sbin:/usr/bin:/usr/X11R6/bin:/opt/eclipse"
